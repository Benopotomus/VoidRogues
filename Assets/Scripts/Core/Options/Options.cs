...
namespace VoidRogues
{
    public sealed class Options
    {
        ...
        {
            return HasKey(key) ? GetValue(key).BoolValue : defaultValue;
        }
        ...
        {
            return HasKey(key) ? GetValue(key).FloatValue.Value : defaultValue;
        }
        ...
        {
            return HasKey(key) ? GetValue(key).IntValue.Value : defaultValue;
        }
        ...
        {
            return HasKey(key) ? GetValue(key).StringValue : defaultValue;
        }
